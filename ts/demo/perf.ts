...
async function measureEncryptMBps(cipher: AesGcmCipher, size: number, rounds: number): Promise<number> {
...
async function measureDecryptMBps(cipher: AesGcmCipher, size: number, rounds: number): Promise<number> {
	const data = randomBytes(size);
